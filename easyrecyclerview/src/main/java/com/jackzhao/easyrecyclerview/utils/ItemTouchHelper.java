...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    ItemOperationListener operationListener;
    ...
    public ItemTouchHelper setSelectedListener(ItemSelectedListener selectedListener) {
        this.selectedListener = selectedListener;
        return this;
    }

    public ItemTouchHelper setOperationListener(ItemOperationListener operationListener) {
...
//                selectedListener.onItemSelected(mSelected.itemView, true);
//            }
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                final RecoverAnimation rv = new RecoverAnimation(prevSelected, animationType, selectedListener,
    ...
    boolean checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        if (operationListener != null && !operationListener.canSwipe(vh)) {
            return false;
        }
            ...
            if (child != null) {
                ...
                if (vh != null) {
                    ...
                    if (pointerId == mActivePointerId) {
                        ...
                        if (mCallback.isLongPressDragEnabled() && (operationListener == null || operationListener.canDrag(vh))) {
                            select(vh, ACTION_STATE_DRAG);
                            setChoosed(child, true);
                            if (selectedListener != null) {
                                selectedListener.onItemSelected(child, true);
                            }
                        }
                    }
                }
    ...
    public static void setChoosed(View view, boolean choosed) {
        if (view != null) {
            if (choosed) {
                view.setScaleX(1.1f);
                view.setScaleY(1.1f);
    ...
    private static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        RecoverAnimation(ViewHolder viewHolder, int animationType, ItemSelectedListener selectedListener,
        ...
        public void start() {
            setChoosed(mViewHolder.itemView, false);
            if (selectedListener != null) {
                selectedListener.onItemSelected(mViewHolder.itemView, false);
            }
    ...
    public interface ItemOperationListener{
        boolean canDrag(ViewHolder viewHolder);
        boolean canSwipe(ViewHolder viewHolder);
    }
